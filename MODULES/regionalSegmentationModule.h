#ifndef REGIONALSEGMENTATIONMODULE_H
#define REGIONALSEGMENTATIONMODULE_H
...
class regionalSegmentationModule: public ModuleInterface {
public:
    regionalSegmentationModule(Datapool *i_data);
    ...
    void completeBlobs(std::vector<Blob> &blobs, QImage *fg, QImage *current);
...
#endif // REGIONALSEGMENTATIONMODULE_H
